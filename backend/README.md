...
## Project Structure
    ...
    ├── testapiautodatamod_119537  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_119537`
...
2. Clone this repo and `cd testapiautodatamod_119537`
